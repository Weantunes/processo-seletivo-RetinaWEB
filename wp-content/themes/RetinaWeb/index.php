...
<head>
    ...
    <title>Processo seletivo - Retina WEB </title>

    <!--Descrição do site-->
    <meta name='description' content='Descrição desse site'>
...
<body>
    ...
    <main>
        ...
        <!--banner Principal-->
        <section id="banner-MainMain" class="banner-main">
            <div class="banners">
        ...
        <!-- Vantagens -->
        <section id="Vantagens" class="banners">
            <div id="Serviços-container" class="container">
        ...
        <!--Conheça a Retina-->
        <section id="SobreNos" class="banners">
            <div id="Serviços-container" class="container">
        ...
        <!-- Clientes -->
        <section id="Clientes" class="banners">
            <div id="Serviços-container" class="container">
                ...
                <div id="Texto-Foto">
                    ...
                    <div>
                        <!--Título do texto-->
                        <h2 class="font12">Clientes que confiam <br>
                            no nosso trabalho</h2>
                        <h3 class="font14">Sabemos a importância da experiência do cliente para os negócios e, portanto,nós nos esforçamos para fazer sua marca se destacar no mercado.</h3>

                        <ul>
                            <!-- <li><img src="assets/svg/arrow-esquerda.svg" alt=""></li>
                            <li><img src="assets/svg/arrow-direita.svg" alt=""></li> -->
                        </ul>
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus a inventore doloribus, aliquam ex officiis aperiam, vitae hic autem vel consequuntur corrupti fuga consectetur. Rem tempora eos eius illo dolore.</p>
